...
public class FIFOPushConsumerExample {
    private static final Logger logger = LoggerFactory.getLogger(FIFOPushConsumerExample.class);

    private FIFOPushConsumerExample() {
    }
