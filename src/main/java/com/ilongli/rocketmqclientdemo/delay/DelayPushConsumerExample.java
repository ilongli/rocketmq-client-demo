...
public class DelayPushConsumerExample {
    private static final Logger logger = LoggerFactory.getLogger(DelayPushConsumerExample.class);

    private DelayPushConsumerExample() {
    }
    ...
    public static void main(String[] args) throws ClientException, IOException, InterruptedException {
        ...
        String consumerGroup = "DelayConsumerGroup";
